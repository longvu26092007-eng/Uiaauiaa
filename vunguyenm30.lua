            ...
            if not invValid then
                ...
                if hasBlack then
                    ...
                    if IsLearnDone() then
                        ...
                        -- FIX: Nếu đang có sẵn weapon nhưng chưa ghi DoneCraft → ghi luôn
                        ...
                        -- FIX: Nếu có Draco race mà chưa ghi DoneRace → ghi luôn (chỉ khi đã IsDracoDetected)
                        ...
                        -- ==========================================
                        -- GATE: CHỈ VÀO FARM MASTERY KHI ĐỦ CẢ HAI
                        -- doneRaceJson == true VÀ doneCraftJson == true
                        -- ==========================================
                        if doneRaceJson and doneCraftJson then
                            ...
                            -- Kick trigger khi đạt mốc mastery
                        ...
                        -- ==========================================
                        -- CHƯA ĐỦ doneRaceJson + doneCraftJson
                        -- ==========================================
                        ...
                        elseif not doneRaceJson then
                            ...
                            -- doneRaceJson = true, doneCraftJson = false
                            -- === BƯỚC 2: FARM NGUYÊN LIỆU & CRAFT ===
