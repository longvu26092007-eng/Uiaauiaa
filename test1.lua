...
Library:Notify({
    Title = "Banana Hub",
    Description = "Chào mừng! UI màu xám đã được load thành công.\nNhấn nút góc trái màn hình để mở GUI.",
    Duration = 4
})
...
function CheckLevel()
    ...
    if Sea1 then
        ...
        elseif v7 == 375 or (v7 <= 399 or SelectMonster == "Fishman Warrior") then
            ...
            if _G.tự động cấp and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
