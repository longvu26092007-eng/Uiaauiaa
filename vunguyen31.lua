                ...
                if hasBlack then
                    ...
                    if IsLearnDone() then
                        ...
                        if doneRaceJson and doneCraftJson then
                            ...
                            -- Ghi file Completed-mastery ngay khi Storm đủ 500
                            -- Không phụ thuộc vào CURRENT_STATE, chỉ cần stormMastery >= 500
                            -- và change1 = true, chưa ghi lần nào
                            if stormMastery >= 500 and getgenv().change1 == true and not masteryFileCreated then
                                pcall(function() writefile(Player.Name .. ".txt", "Completed-mastery") end)
                                masteryFileCreated = true
                                warn("[DracoHub] Đã ghi file " .. Player.Name .. ".txt → Completed-mastery")
                            end
